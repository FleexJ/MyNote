...
public class MainSwipeListener implements View.OnTouchListener {
    ...
    public MainSwipeListener(Activity _activity) {
        activity = _activity;
...
//        activity.recreate();
//        Toast.makeText( activity.getApplicationContext(), "Обновлено", Toast.LENGTH_SHORT).show();
    }
